    ...
    <div class=\"col-md-3 offset-md-3\">
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "hasPermission", [0 => "administer nodes"], "method", false, false, true, 10)) {
                // line 11
                echo "        <a href=\"/admin/anzy/catsDel/";
                ...
                echo "?destination=";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["dest"] ?? null), 11, $this->source), "html", null, true));
        ...
        <a href=\"/admin/anzy/catsChange/";
                ...
                echo "?destination=";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["dest"] ?? null), 12, $this->source), "html", null, true));
...
";
    ...
    {
        return array (  102 => 16,  98 => 14,  89 => 12,  80 => 11,  78 => 10,  72 => 9,  66 => 8,  60 => 7,  56 => 5,  52 => 4,  48 => 3,  44 => 2,  39 => 1,);
    }
